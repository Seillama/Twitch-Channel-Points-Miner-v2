...
twitch_miner = TwitchChannelPointsMiner(
    ...
    password=os.environ['TWITCH_PASSWORD'],     # If no password will be provided, the script will ask interactively
...
twitch_miner.mine(json.loads(os.environ['TWITCH_STREAMERS']), followers=False)
